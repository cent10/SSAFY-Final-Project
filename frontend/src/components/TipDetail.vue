    ...
    <b-list-group flush class="text-left">
        <b-list-group-item v-for="(onecomment,id) in notice.comments" :key="id" class="px-3">
          <b-row>
            ...
            <b-col cols="2"><p class="m-0">{{ onecomment.user.username }}</p></b-col>
            <b-col cols="4">
...
export default {
  ...
  methods: {
    ...
    //     method: "POST",
    //     url:
    //       `${API_URL}/articles_find/comment/create/` +
    ...
    //         method: "PUT",
    //         url:
    //           `${API_URL}/articles_find/comment/update/` +
    //           this.$route.params.pk +
    //           "/" +
    //           this.commenter.id +
    //           "/",
    ...
    //         method: "DELETE",
    //         url:
    //           `${API_URL}/articles_find/comment/delete/` +
    //           this.$route.params.pk +
    //           "/" +
    //           cmt_id +
    //           "/",
