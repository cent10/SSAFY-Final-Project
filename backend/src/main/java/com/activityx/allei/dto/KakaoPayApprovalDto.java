...
public class KakaoPayApprovalDto {
	...
	private KakaoPayCardDto card_info;
	...
	public KakaoPayAmountDto getAmount() {
		return amount;
	}
	public void setAmount(KakaoPayAmountDto amount) {
		this.amount = amount;
	}
	public KakaoPayCardDto getCard_info() {
		return card_info;
	}
	public void setCard_info(KakaoPayCardDto card_info) {
